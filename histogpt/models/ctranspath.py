...
def swin_base_patch4_window12_384_in22k(embed_layer,
                                        pretrained=False,
                                        **kwargs):
    model = SwinTransformer(embed_layer=embed_layer,
                            patch_size=4,
...
def swin_base_patch4_window7_224_in22k(embed_layer,
                                       pretrained=False,
                                       **kwargs):
    model = SwinTransformer(embed_layer=embed_layer,
                            patch_size=4,
...
def swin_large_patch4_window12_384_in22k(embed_layer,
                                         pretrained=False,
                                         **kwargs):
    model = SwinTransformer(embed_layer=embed_layer,
                            patch_size=4,
...
def swin_large_patch4_window7_224_in22k(embed_layer,
                                        pretrained=False,
                                        **kwargs):
    model = SwinTransformer(embed_layer=embed_layer,
                            patch_size=4,
